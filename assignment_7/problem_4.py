...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr  4 10:58:16 2024
...
# Ill-conditioned matrix warning when using the Rayleigh quotient iterator.
# Solutions look normal though, so who cares...
...
# === Finding energy eigenvalues from Hamiltonian (harmonic potential) ===

x = cf / np.tan(t)

hamilt = -0.5 * lapl + np.diag(aux.hpotential(x))
